...
function handleClick(property) {
  alert(
    "Property for " +
      ...
      "=" +
      property.checked +
      " has successfuly applied"
  );
  if (property.value == "autoenter") {
    if (property.checked == true) scanner.setProperty("autoenter", "true");
    else scanner.setProperty("autoenter", "false");
  } else if (property.value == "autotab") {
    if (property.checked == true) scanner.setProperty("autotab", "true");
    else scanner.setProperty("autotab", "false");
  } else if (property.value == "allDecoders") {
    if (property.checked == true) scanner.setProperty("allDecoders", "true");
    else scanner.setProperty("allDecoders", "false");
  }
